  ...
  \begin{columns}[T]
    ...
    \begin{column}{0.31\textwidth}
      \begin{block}{Các trạng thái hoạt động}
        \small
        \begin{itemize}
          \item \texttt{\scriptsize STATE\_RUNNING:} Hoạt động bình thường. Giải mã dữ liệu và điều phối động cơ bằng vi sai.
          \item \texttt{\scriptsize STATE\_FAIL\_SAFE:} Trạng thái dừng an toàn. Dừng xe khẩn cấp khi mất sóng quá \textbf{\qty{300}{\ms}}.
        \end{itemize}
      \end{block}
    \end{column}
  \end{columns}
