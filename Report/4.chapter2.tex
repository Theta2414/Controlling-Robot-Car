...
\hline
Mọi trạng thái & STATE\_FAIL\_SAFE & Mất kết nối Bluetooth quá \qty{0.3}{\second} (\qty{300}{\ms}) & Tắt PWM (\qty{0}{\percent}), dừng khẩn cấp xe \\
\hline
STATE\_FAIL\_SAFE & STATE\_STOP & Kết nối Bluetooth được khôi phục & Reset bộ đệm, chờ lệnh mới \\
\hline
STATE\_STOP & STATE\_FORWARD & Nhận được giá trị điều khiển $F > 0$ & Xuất GPIO tiến, phát PWM điều tốc \\
\hline
STATE\_STOP & STATE\_BACKWARD & Nhận được giá trị điều khiển $F < 0$ & Xuất GPIO lùi, phát PWM điều tốc \\
\hline
STATE\_STOP & STATE\_LEFT & Nhận được giá trị điều khiển $T < 0$ & Xuất GPIO rẽ trái, phát PWM điều tốc \\
\hline
STATE\_STOP & STATE\_RIGHT & Nhận được giá trị điều khiển $T > 0$ & Xuất GPIO rẽ phải, phát PWM điều tốc \\
\hline
STATE\_FORWARD / BACKWARD / LEFT / RIGHT & STATE\_STOP & Nhận được giá trị \(F = \num{0}\) và \(T = \num{0}\) & Tắt xung PWM, dừng động cơ xe \\
\hline
\end{tabularx}
\end{table}
...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{Drawio/Transmitter_FSM.drawio.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{Drawio/Receiver_FSM.drawio.pdf}
