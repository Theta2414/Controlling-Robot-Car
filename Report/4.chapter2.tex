...
\begin{itemize}
    ...
    \item Xử lý dải chết (Deadzone): Nếu góc nghiêng nhỏ hơn $15^\circ$, coi như tay nằm ngang (Lệnh Dừng). Nếu vượt quá $25^\circ$, bắt đầu tính toán lệnh di chuyển và ánh xạ góc nghiêng sang mức tốc độ PWM tương ứng.
...
\begin{itemize}
    ...
    \item Vòng lặp chính:
    \begin{itemize}
        \item Liên tục kiểm tra biến đếm thời gian (Timeout Counter). Nếu thời gian trôi qua từ lần nhận gói tin cuối cùng vượt quá \qty{1500}{\milli\second}, hệ thống tự động đưa xe về trạng thái dừng khẩn cấp (Fail-Safe), tắt xung PWM và ngắt dòng động cơ.
...
\hline
Mọi trạng thái & STATE\_FAIL\_SAFE & Mất kết nối Bluetooth quá 1.5 giây & Tắt PWM (0\%), dừng khẩn cấp xe \\
\hline
STATE\_FAIL\_SAFE & STATE\_STOP & Kết nối Bluetooth được khôi phục & Reset bộ đệm, chờ lệnh mới \\
\hline
STATE\_STOP & STATE\_FORWARD & Góc Pitch tay cầm $> 25^\circ$ & Xuất GPIO tiến, phát PWM điều tốc \\
\hline
STATE\_STOP & STATE\_BACKWARD & Góc Pitch tay cầm $< -25^\circ$ & Xuất GPIO lùi, phát PWM điều tốc \\
\hline
STATE\_STOP & STATE\_LEFT & Góc Roll tay cầm $< -25^\circ$ & Xuất GPIO rẽ trái, phát PWM điều tốc \\
\hline
STATE\_STOP & STATE\_RIGHT & Góc Roll tay cầm $> 25^\circ$ & Xuất GPIO rẽ phải, phát PWM điều tốc \\
\hline
STATE\_FORWARD / BACKWARD / LEFT / RIGHT & STATE\_STOP & Góc Pitch và Roll nằm trong dải chết ($\pm 15^\circ$) & Tắt xung PWM, dừng động cơ xe \\
\hline
\end{tabularx}
\end{table}
