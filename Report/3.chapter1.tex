...
\begin{itemize}
    ...
    \item Tích hợp bộ lọc Kalman để lọc nhiễu và ước lượng chính xác góc nghiêng Pitch và Roll từ cảm biến MPU6050; không tích hợp bộ điều khiển PID cho động cơ.
